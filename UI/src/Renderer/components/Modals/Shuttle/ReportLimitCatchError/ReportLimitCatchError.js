        ...
        <Dialog open={open}>
            <>
                <DialogContent style={{overflowX: 'hidden'}}>
                    ...
                    <br />
                    <Typography>Please fill out this form to submit a report to Ghost Gunner tech support letting us know about the error. This will also disable the soft limit popup on your machine. You can re-enable this popup at any time in the Settings menu.</Typography>
                    <br />
                    <br />
