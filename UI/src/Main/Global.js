...
export class Global {
    ...
    static getLinkKey() {
        return this.getProperty('linkKey');
    }

    static setLinkKey(value) {
        try {
            this.setProperty('linkKey', value);
        } catch (e) {
            throw new Error(`could not update linkKey: ${e.message}`);
        }
    }
