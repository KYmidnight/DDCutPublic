...
// There should be a preprocessor macro in Serial Connection and Ghost Gunner Finder that enables this mock controller
...
private:
	...
	std::string m_Firmware{ "[grbl:1.1h GG:3B PCB:3B VFD:3A YMD:20201212]" };
