...
void M100(const string& args) {
	GhostDisplayManager::AddLine(ELineType::WRITE, "M100 In Progress...");
	...
	if (m100points.empty()) { 
		GhostDisplayManager::AddLine(ELineType::ERR, "M100 Failed");
	...
	MILL_LOG("END");
	GhostDisplayManager::AddLine(ELineType::READ, "M100 Complete");
}
