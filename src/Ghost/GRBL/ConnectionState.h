...
public:
	...
	void UpdateState() noexcept {
		...
		if (delta > timeout) {
			...
			DD_LOG("Timeout while updating state.");
	...
	// Not yet thread-safe
	const GhostSettings& GetSettings() const noexcept { return m_settings; }
...
private:
	...
	GhostSettings m_settings;	// Not yet thread-safe
