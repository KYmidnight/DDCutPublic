...
auto DetectCompatibleDevice(std::list<GhostGunner>& output) noexcept -> void
{
...
auto GhostGunnerFinder::GetAvailableGhostGunners() const
    -> std::list<GhostGunner>
{
    auto output = std::list<GhostGunner>{};
