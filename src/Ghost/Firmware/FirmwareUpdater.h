...
public:
	static std::unique_ptr<FirmwareUpdater> Initialize(const GhostConnector::Ptr& pConnector);
	~FirmwareUpdater();
...
private:
	FirmwareUpdater(const GhostConnector::Ptr& pConnector)
...
private:
	GhostConnector::Ptr m_pConnector;
